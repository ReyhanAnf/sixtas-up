...
export default async function OtherPosts() {
  ...
  const mypost = (await getMyPost(param?.id.toString())).data;
  const dataUser = (await getUser(param?.id.toString())).data;
          ...
          <CardHeader className="flex gap-3 justify-between">
            <div className="flex gap-5">
              ...
              <div className="flex flex-col gap-1 items-start justify-center">
                <h4 className="text-small font-semibold leading-none text-default-600">{dataUser[0].first_name}</h4>
